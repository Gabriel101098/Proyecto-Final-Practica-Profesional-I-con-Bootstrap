...
function mostrarListado() {
    var lista = '<div class="table-responsive">'; // Contenedor responsive
    lista += '<table class="table table-bordered table-striped table-hover mx-auto">'; // Clases de Bootstrap
    lista += '<thead class="table-dark"><tr><th>N°</th><th>PELICULAS</th><th>PROTAGONISTA</th><th>DURACION</th><th>GENERO</th><th>PREMIACION</th></tr></thead>';
    lista += '<tbody>';
    ...
    for (var i = 0; i < nombre.length; i++) {
        ...
        lista += '<td>' + (premiacion[i] ? "Sí" : "No") + '</td>';
        lista += '</tr>';
    }
    
    lista += '</tbody></table></div>'; // Cerrar div contenedor
...
function premiadas(){
    var listaPremiadas = '<div class="table-responsive">';
    listaPremiadas += '<table class="table table-bordered table-striped table-hover mx-auto">';
    listaPremiadas += '<thead class="table-dark"><tr><th>N°</th><th>PELICULAS</th><th>PROTAGONISTA</th><th>DURACION</th><th>GENERO</th><th>PREMIACION</th></tr></thead>';
    ...
    listaPremiadas += '</tbody></table></div>';
    document.getElementById("salida").innerHTML = listaPremiadas;
}
function noPremiadas(){
    var listaNoPremiadas = '<div class="table-responsive">';
    listaNoPremiadas += '<table class="table table-bordered table-striped table-hover mx-auto">';
    listaNoPremiadas += '<thead class="table-dark"><tr><th>N°</th><th>PELICULAS</th><th>PROTAGONISTA</th><th>DURACION</th><th>GENERO</th><th>PREMIACION</th></tr></thead>';
    ...
    listaNoPremiadas += '</tbody></table></div>';
